...
تمت مزامنة أصول ملف APK المحلي إلى `ios-scaffold/Resources/LegacyAssets`، وتم توليد نسخ metadata مكبرة داخل `LegacyAssets/iphone-hd-upscaled` لملفات Sprite sheet بصيغة `.plist` بنسبة 1.875 حتى تطابق صور 1920x1920 عند توفرها.
